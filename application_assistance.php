...
// Fetch counsellors specializing in University Application Assistance
$sql = "SELECT name, email, phone FROM counsellor WHERE specialization = 'University Application'";
