...
// Fetch counsellors specializing in Scholarship Information
$sql = "SELECT name, email, phone FROM counsellor WHERE specialization = 'Scholarship Information'";
...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>No counsellors available for Scholarship Information at the moment.</p>";
        }
        ?>
        <a href="scholarship_info.html" class="btn">Back</a>
    </div>
    <footer>
